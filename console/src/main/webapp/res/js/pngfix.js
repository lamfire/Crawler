...
var DD_belatedPNG = {
	...
	handlePseudoHover: function(el) {
		...
		setTimeout(function() { /* wouldn't work as intended without setTimeout */
			...
			if(DD_belatedPNG) DD_belatedPNG.applyVML(el);
...
DD_belatedPNG.fix('img, div, h1, h2, h3, h4, input,textarea');
DD_belatedPNG.fix('#header #action-bar #nav ul li a');
DD_belatedPNG.fix('.project-thumbnails .project-1 a, .project-thumbnails .project-2 a, .project-thumbnails .project-3 a');
